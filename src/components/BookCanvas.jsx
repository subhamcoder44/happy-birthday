...
const BookCanvas = ({ active, setActive }) => {
    ...
    useEffect(() => {
        // When the card becomes visible (active === false), try to autoplay the song.
        if (audioRef.current) {
            if (!active) {
                ...
                if (playPromise !== undefined) {
                    playPromise.then(() => {
                        ...
                        // Autoplay may be blocked by the browser; console for debugging
                        // We keep UI showing play button so user can manually start it.
    ...
    useEffect(() => {
        // Try autoplay on initial load (best-effort). If blocked, attempt muted autoplay and wait for user click to enable sound.
        const tryAutoplay = async () => {
            ...
            try {
                ...
                try {
                    ...
                    // Even muted autoplay failed; mark blocked and wait for user interaction
                    setAutoplayBlocked(true)
                }
            }
        }
        ...
        return () => window.removeEventListener('click', enableSoundOnFirstInteraction)
    }, [])
                ...
                <div className="card1">
                    <div className="cover-text-wrapper">
                        <h4 className="username">
                            Dear Debasmita<span className="underline"></span>
                        </h4>
                ...
                <div className="card2">
                    <div className="card2-content">
                        ...
                        <div className="card2-message-text italic">
                            <article style={{ marginBottom: '8px' }}>Happy Birthday, Debasmita ❤️</article>
                        ...
                        {/* Audio moved to site root - no in-card play button */}
