...
const SmallLetter = () => {
    ...
    <div className="small-rajib-paper-content">
        ...
        <p>Dear Debasmita,<br /><br />Your smile lights up every quiet moment, and your presence makes ordinary days feel like a beautiful story. You have a gentle strength that comforts me, and your kindness turns simple memories into something unforgettable.<br /><br />With every laugh, every shared dream, and every warm word from you, my world becomes brighter. I am grateful for you today and always.<br /><br />Your Friend, Subham</p>
    </div>
